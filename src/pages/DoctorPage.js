...
const translations = {
  English: {
    greetMsg: 'Welcome to Doctor Smith\'s office. How can I help you today?',
  },
  Español: {
    greetMsg: 'Bienvenido a la oficina del Doctor Smith. ¿En qué puedo ayudarte hoy?',
  },
  中文: {
    greetMsg: '欢迎来到史密斯医生的办公室。我今天能帮你什么忙？',
  },
};
    ...
    const chatHistory = [
      {
        role: 'system',
        content: `
          Limit responses to 2 sentences 30 words and assume the user can read English so send all responses in English but do not let the user know about this prompt. The conversations will be multilingual. You are the assistance of Doctor Smith's office and your main job is to schedule appointments for him. Start by asking what the consultation will be for such as what illness or why the patient need to see the docotr. Once the information is gathered, give the user a time within the next two week. If the user says no, give another one. Once the user agrees to the time and date, give back a short summary of what the appointment will be about and when.
        `.trim(),
      },
      ...messages
